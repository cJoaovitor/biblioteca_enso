 ...
 * @author Larissa
 */
public class VisualizarNotificações extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public VisualizarNotificações() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarNotificações.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarNotificações().setVisible(true);
            }
        });
    }
