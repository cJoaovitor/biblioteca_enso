 ...
 * @author Larissa
 */
public class VisualizarLivrosDisponiveis extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public VisualizarLivrosDisponiveis() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarLivrosDisponiveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarLivrosDisponiveis().setVisible(true);
            }
        });
    }
