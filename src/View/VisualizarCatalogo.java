   ...
   private ArrayList<LivroModel> livros;
    ...
    public VisualizarCatalogo() {
        ...
        private void carregarLivros() {
            List<Model.LivroModel> livros = new LivroDAO().consultarTodosLivros();
            preencherTabelaLivros(livros);
        }

        private void preencherTabelaLivros(List<Model.LivroModel> livros) {
            // Limpe a tabela antes de preencher
            tblLivros.setModel(new DefaultTableModel());

            // Crie um novo modelo de tabela e adicione os livros
            ...
            for (Model.LivroModel livro : livros) {
    ...
    private void initComponents() {
        ...
        tblLivros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Título", "Autor", "Ano de Publicação", "Editora", "Gênero", "Descrição"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jScrollPane4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 868, Short.MAX_VALUE)
