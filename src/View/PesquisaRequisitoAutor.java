...
public class PesquisaRequisitoAutor extends javax.swing.JFrame {
    ...
    public PesquisaRequisitoAutor() {
        initComponents();
    }
    
      private void preencherTabelaLivros(List<LivroModel> livros) {
        DefaultTableModel model = (DefaultTableModel) tblLivrosAutor.getModel();
    ...
    private void initComponents() {
        ...
        jLabel16.setText("PESQUISA - AUTOR");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtAutor, javax.swing.GroupLayout.PREFERRED_SIZE, 730, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String autorPesquisado = txtAutor.getText();
        List<LivroModel> livrosAutor = Dados.buscarLivrosPorAutor(autorPesquisado);

        if (livrosAutor.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nenhum livro encontrado para o autor informado.");
        } else {
            preencherTabelaLivros(livrosAutor);
        }
